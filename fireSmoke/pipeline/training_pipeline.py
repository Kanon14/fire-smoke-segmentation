...
from fireSmoke.components.data_ingestion import DataIngestion
from fireSmoke.components.data_validation import DataValidation
from fireSmoke.components.model_trainer import ModelTrainer
